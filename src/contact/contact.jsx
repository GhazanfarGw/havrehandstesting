                        ...
                        <div className='mx-auto'>
                            <div className='md:grid md:grid-cols-2 lg:gap-x-8 mx-auto justify-center'>
                                <div className='lg:py-3 md:py-3 py-2'>
                                    ...
                                    <input
                                        className='bg-[#f0f0f0] border mt-2 py-2 w-full px-4 mx-auto border-[#18C4FF] shadow-lg'
                                        type="text"
                                        value={first_name}
                                        required
                                ...
                                <div className='lg:py-3 md:py-3 py-2'>
                                    ...
                                    <input
                                        className='bg-[#f0f0f0] border mt-2 py-2 w-full px-4 mx-auto border-[#18C4FF]'
                                        type="text"
                                        value={last_name}
                                        required
                            ...
                            <div className='mt-5'>
                                ...
                                <textarea
                                    className='bg-[#f0f0f0] border pb-40 py-5 w-full px-4 mx-auto mt-2 overflow-y-hidden border-[#18C4FF]'
                                    type="message"
                                    id="message"
                                    value={message}
                                    required
                            ...
                            <div className='items-center'>
                                <button className='bg-[#18C4FF] px-10 tracking-wider py-2 md:mt-10 mt-5 text-white' type="submit">
